...
#'
#' @name NGD
#' @param x q a vector or matrix of quantiles at which the pdf needs to be computed.
...
#' @param alpha the shape parameter that must be positive.
#' @param lambda the scale parameter that must be positive.
#'
#' @return
